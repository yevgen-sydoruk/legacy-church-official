  ...
  try {
    ...
    const mailData = {
      ...
      html: `
        ...
        <br/>
        <div><strong>Demographics:</strong> ${body.demographics}</div>
        <br/>
        <div><strong>Interested in topics:</strong> ${body.checkboxOptions}</div>
        <br/>
        <div><strong>Interested in Couples Group:</strong> ${body.couples_group_interest}</div>
        <br/>
