...
export async function POST(req) {
  try {
    ...
    const mailData = {
      ...
      replyTo: body.email,
      subject: `New Prayer Request - Legacy Web Page`,
      html: `
        ...
        <br/>
        <div><strong>Follow Up Interest:</strong> ${body.follow_up_interest}</div>
        <br/>
        <div><strong>Prayer Request:</strong> ${body.prayer_request}</div>
        <br/>
